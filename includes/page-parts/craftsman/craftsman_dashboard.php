...
<body>
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center py-2">
            <div class="breadcrumb-title pe-3 small"><?php echo lang("craftsman_dashboard"); ?></div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 small">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a></li>
                        <li class="breadcrumb-item active small" aria-current="page"><?php echo lang("dashboard"); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-3 mb-3">
                ...
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("my_packet"); ?> <span class="fw-500"><?php echo lang("form"); ?></span></h6>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <a href="index.php?route=modules/craftman/edit_my_packet"
                                    class="btn btn-success rounded-4 px-3 btn-sm small"><?php echo lang("edit_packet"); ?></a>
                            </div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("digital"); ?> <span class="fw-500"><?php echo lang("signature"); ?></span></h6>
                        </div>
                        <h6 style="font-size: 0.7rem; color: red;"><?php echo lang("signature_auth_message"); ?></h6>
                        <form id="signatureForm" method="POST" action="">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <button type="button" class="btn btn-success rounded-4 px-3 btn-sm"
                                    ...
                                    <?= isset($user['signature']) ? lang("update_signature") : lang("input_signature") ?>
                                </button>
                                <div class="">
                                    <img src="<?= htmlspecialchars($have_signature['signature']) ?>" alt="<?php echo lang("signature"); ?>"
                        ...
                        <div id="successMessage" class="text-success small" style="display:none; margin-top: -12px;">
                            <?php echo lang("signature_updated"); ?>!
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="signatureModal"
                ...
                <div class="mt-2">
                    <button onclick="clearSignature()" class="btn btn-warning btn-sm"><?php echo lang("clear"); ?></button>
                    <button onclick="saveAndSubmitSignature()" class="btn btn-success btn-sm"><?php echo lang("save"); ?></button>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("upload"); ?> <span class="fw-500"><?php echo lang("profile_picture"); ?></span></h6>
                        </div>
                        <form id="profilePicForm" method="POST" enctype="multipart/form-data" action="">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="profile-pic-container">
                                    <img id="profileImage"
                                        ...
                                        alt="<?php echo lang("profile_picture"); ?>" class="profile-pic"
                            ...
                            <div id="uploadLoading" class="text-center mt-2" style="display: none;">
                                ...
                                <span class="small ms-2"><?php echo lang("uploading"); ?>...</span>
                            </div>

                            <!-- Success message (hidden by default) -->
                            <div id="uploadSuccess" class="text-center text-success small mt-2" style="display: none;">
                                <i class="fas fa-check-circle"></i> <?php echo lang("upload_success"); ?>
                            </div>
                        </form>
                    </div>
                </div>
 ...
 <!-- Add this card to your dashboard -->
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("change"); ?> <span class="fw-500"><?php echo lang("password"); ?></span></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div class="mb-3" style="height: 1.7rem;"></div>
                                <a href="index.php?route=modules/profile/profile"
                                    class="btn btn-orange rounded-4 px-3 btn-sm small"><?php echo lang("change_here"); ?></a>
                            </div>
                            <div class="bg-orange-50 rounded-2 card-icon-sm">
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("assigned"); ?> <span class="fw-500"><?php echo lang("tasks"); ?></span></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small">
                                <?php echo lang("upcoming"); ?> <span class="fw-500"><?php echo lang("meetings"); ?></span>
                            </h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="mb-2 text-indigo">5</h4>
                                <a href="#" class="btn btn-orange rounded-4 px-3 btn-sm small"><?php echo lang("view_schedule"); ?></a>
                            </div>
                            <div class="bg-orange-50 rounded-2 card-icon-sm">
