...
<aside class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="sidenav">
            ...
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title"><?php echo lang("sidebar_Superintendent"); ?></div>
                </a>
                <ul>
                    <li>
                        <!-- 
    <li><a href="index.php?route=modules/craftman/fill_my_packet">
     ...
     -->
                    ...
                    <li>
                    <li><a href="index.php?route=modules/daily_forms/work_form">
                            <i class="material-icons-outlined icon">edit</i> <?php echo lang("Superintendent_add_daily_work"); ?>
                        </a>
                    </li>
                    <li><a href="index.php?route=modules/daily_forms/view_work_form">
    <i class="material-icons-outlined icon">visibility</i> <?php echo lang("Superintendent_view_daily_work"); ?>
</a></li>
                    <!-- <li>
