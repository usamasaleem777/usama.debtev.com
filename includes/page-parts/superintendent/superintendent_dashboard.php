...
<body>
    <div class="container-fluid">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center py-2">
            <div class="breadcrumb-title pe-3 small"><?php echo lang("Superintendent_Dashboard"); ?></div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 small">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a></li>
                        <li class="breadcrumb-item active small" aria-current="page"><?php echo lang("Superintendent_dashboard"); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-3 mb-3">
                ...
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("Superintendent_My_work"); ?><span class="fw-500"> <?php echo lang("Superintendent_Form"); ?></span></h6>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <a href="index.php?route=modules/daily_forms/work_form"
                                    class="btn btn-success rounded-4 px-3 btn-sm small"><?php echo lang("Superintendent_add_data"); ?></a>
                            </div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("Superintendent_Digital"); ?> <span class="fw-500"><?php echo lang("workform_Signature"); ?></span></h6>
                        </div>
                        <h6 style="font-size: 0.7rem; color: red;"><?php echo lang("Superintendent_I authorize my signature to be used on CRAFT forms."); ?></h6>
                        ...
                        <div id="successMessage" class="text-success small" style="display:none; margin-top: -12px;">
                            <?php echo lang("Superintendent_Signature Updated!"); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="signatureModal"
                ...
                <div class="mt-2">
                    <button onclick="clearSignature()" class="btn btn-warning btn-sm"><?php echo lang("Superintendent_Clear"); ?></button>
                    <button onclick="saveAndSubmitSignature()" class="btn btn-success btn-sm"><?php echo lang("Superintendent_save"); ?></button>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("Superintendent_upload"); ?> <span class="fw-500"><?php echo lang("Superintendent_profile_picture"); ?></span></h6>
                        </div>
                        <form id="profilePicForm" method="POST" enctype="multipart/form-data" action="">
                            ...
                            <div id="uploadLoading" class="text-center mt-2" style="display: none;">
                                <div class="spinner-border text-primary spinner-border-sm" role="status">
                                    <span class="visually-hidden"><?php echo lang("Superintendent_loading"); ?></span>
                                </div>
                                <span class="small ms-2"><?php echo lang("Superintendent_uploading"); ?></span>
                            </div>

                            <!-- Success message (hidden by default) -->
                            <div id="uploadSuccess" class="text-center text-success small mt-2" style="display: none;">
                                <i class="fas fa-check-circle"></i> <?php echo lang("Superintendent_Picture uploaded successfully"); ?>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("Superintendent_Current"); ?> <span class="fw-500"><?php echo lang("Superintendent_Weather"); ?></span></h6>
                            <span id="weatherCity" class="ms-auto small text-muted"></span>
                        </div>

                        <div class="weather-info" id="weatherInfo">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <div class="loader small"><?php echo lang("Superintendent_Detecting_location"); ?></div>
                                    <div id="weatherDetails" style="display: none;">
                                        <div class="d-flex align-items-center mb-1">
                                            <img id="weatherIcon" src="" alt="Weather Icon" style="width: 30px; height: 30px;">
                                            <span id="weatherCondition" class="ms-2 small"></span>
                                        </div>
                                        <div class="small">
                                            <div>🌡 <span id="weatherTemp"></span>°C</div>
                                            <div>💧 <span id="weatherHumidity"></span>%</div>
                                            <div>🌬 <span id="weatherWind"></span> kph</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-orange-50 rounded-2 card-icon-sm">
                                    <span class="material-icons-outlined text-orange">cloud</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("Superintendent_Change"); ?><span class="fw-500"> <?php echo lang("Superintendent_Password"); ?></span></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div class="mb-3" style="height: 1.7rem;"></div>
                                <a href="index.php?route=modules/profile/profile"
                                    class="btn btn-orange rounded-4 px-3 btn-sm small"><?php echo lang("Superintendent_Change_Here"); ?></a>
                            </div>
                            <div class="bg-orange-50 rounded-2 card-icon-sm">
            ...
            <div class="col">
                <div class="card rounded-3 h-80">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <h6 class="mb-0 small"><?php echo lang("Superintendent_Assigned"); ?> <span class="fw-500"><?php echo lang("Superintendent_Tasks"); ?></span></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <a href="" class="btn btn-orange rounded-4 px-3 btn-sm small">
                                    <?php echo lang("Superintendent_Manage_Tasks"); ?>
                                </a>
                            </div>
                            <div class="bg-orange-50 rounded-2 card-icon-sm">
                                <span class="material-icons-outlined text-orange">assignment</span>
        ...
        <script>
            const apiKey = "3a465f273dd647ba804212350251205"; // Replace with your WeatherAPI key
            ...
            async function getWeatherByLocation(lat, lon) {
                ...
                try {
                    ...
                    document.getElementById("weatherCity").textContent = `${data.location.name}, ${data.location.country}`;
                    ...
                    console.error(err);
                    document.querySelector(".loader").textContent = "Weather data unavailable";
                }
            }
            ...
            function getLocationAndWeather() {
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        ...
                        error => {
                            document.querySelector(".loader").textContent = "Enable location access";
                        }
                    );
                } else {
                    document.querySelector(".loader").textContent = "Geolocation not supported";
                }
            }
            ...
            window.onload = () => {
                ...
                setInterval(getLocationAndWeather, 20000);
            };
        </script>