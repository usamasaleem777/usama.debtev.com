...
$mail->Host       = 'localhost';        // Use localhost since your SMTP server is on your machine
$mail->SMTPAuth   = false;              // No authentication if not required locally
$mail->Port       = 465;                 // Default SMTP port (adjust if your local server listens on another port)
