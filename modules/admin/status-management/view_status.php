        ...
        <div class="page-header d-flex align-items-center justify-content-end mt-2 mb-2">
            <div>
                <ol class="breadcrumb float-sm-right mt-2">
                    ...
                    <li class="breadcrumb-item">
                        <a href="index.php?route=modules/admin/status-management/view_status"
                            style="color: #fe5500"><?php echo lang("status_view"); ?></a>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="card border-top" style="border-color: #FE5500 !important;">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div>
                            <h5 class="mb-0 fw-bold" style="color: #FE5500;"><?php echo lang("role_all_status"); ?></h5>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-hover border text-nowrap mb-0 datatable mt-3 w-100"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #FE5500; color: white;">
                                        <?php echo lang("role_Title"); ?>
                                    </th> <!-- Role title -->
                                    <th style="background-color: #FE5500; color: white;">
                                        <?php echo lang("role_status"); ?>
                                    </th> <!-- Role title -->
                                    <th class="text-center" style="background-color: #FE5500; color: white;">
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $statuss = DB::query("SELECT * FROM `status`");

                                    if (!empty($statuss)) {
                                        // Loop through each role and display in table row
                                        foreach ($statuss as $itr => $status) {
                                            ?>
                                            <tr>
                                                <td class="text-center"><?php echo ($itr + 1); ?></td> <!-- Row number -->
                                                <td><?php echo htmlspecialchars($status['title']); ?></td> <!-- Role name -->
                                                <td>
                                                    <?php
                                                    if ($status['status'] == 1) {
                                                        echo 'Active';
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="index.php?route=modules/admin/status-management/edit_status&status_id=<?php echo $status['id']; ?>&status_title=<?php echo urlencode($status['title']); ?>"
                                                        class="btn edit_btn" title="<?php echo lang("status_edit"); ?>"
                                                    ...
                                                    <button type="button" onclick="confirmDeleteRole(<?php echo $status['id']; ?>)"
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-center"><i
                                                    class="fas fa-info-circle me-2"></i><?php echo lang("role_no_found_roles"); ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
    ...
    function confirmDeleteRole(roleId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'index.php?route=modules/admin/status-management/processStatusForm',
                    type: 'POST',
                    data: {
                        status_id: roleId,
