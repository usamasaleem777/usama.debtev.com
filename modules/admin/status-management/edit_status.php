                    ...
                    <ol class="breadcrumb float-sm-right mt-2">
                        ...
                        <li class="breadcrumb-item">
                            <a href="index.php?route=modules/admin/status-management/add"
                                style="color: #fe5500"><?php echo lang("status_add_status"); ?>
                            </a>
                        </li>
                        <!-- Edit status breadcrumb (current page) -->
                        <li class="breadcrumb-item active">
                            <?php echo lang("status_edit"); ?>
                        </li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" id="status_id" name="status_id"
                                                value="<?= (isset($_GET['status_id'])) ? $_GET['status_id'] : '' ?>" />

                                            <!-- status Title Input -->
                                            <label for="status_title" class="form-label">
                                                <?php echo lang("status_status_title"); ?>
                                            </label>
                                            <input type="text" class="form-control" name="status_title"
                                                id="status_title" required minlength="3" maxlength="50"
                                                pattern="[A-Za-z ]+"
                                                title="Only letters and spaces are allowed, min 3 and max 50 characters"
                                                value="<?= (isset($_GET['status_title'])) ? $_GET['status_title'] : '' ?>" />
                                        </div>
