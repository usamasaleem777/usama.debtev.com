...
<body style="background: #f1f2f6;">
    ...
    <div class="container my-4">
        <div class="col-lg-10 mx-auto bg-white p-4 shadow">
            <h1 class="mb-5 text-center" id="formHeading">W4 Form</h1>
            ...
            <form id="employmentApplication" action="submit_application.php" method="post">
                ...
                <div id="step1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="fullname" class="form-label">First & Middle name </label>
                            <input type="text" class="form-control" id="fullname" name="full_name" value="<?php
                            if (isset($applicant['first_name']) || isset($applicant['middle_initial'])) {
                                echo htmlspecialchars(($applicant['first_name'] ?? '') . ' ' . ($applicant['middle_initial'] ?? ''));
                            } else {
                                echo '';
                            }
                            ?>" readonly>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="lastname" name="last_name" value="<?php
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <label for="zip" class="form-label">Current Status</label>
                            <select class="form-control" name="martial_status">
                                <option value="1">Single or Married filing separately</option>
                                <option value="2">Married filing jointly or Qualifying surviving spouse</option>
                                <option value="3">Head of Household</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="phoneNumber" class="form-label">Social Security Number </label>
                            <input type="ssn" class="form-control" id="ssn" name="ssn" value="<?php
                            if (isset($applicant['ssn'])) {
                                echo htmlspecialchars($applicant['ssn']);
                            } else {
                                echo '';
                            }
                            ?>" readonly>
        ...
        <div id="step2" style="display: none;">
            <h3>Claim Dependent and Other Credits</h3>
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="Under17" class="form-label">Multiply number of qualifying children under 17 by
                        $2,000</label>
                    <input type="text" class="form-control" id="under17" name="under17" required>
                </div>
                <div class="col-md-6">
                    <label for="other" class="form-label">Multiply the number of other dependents by $500 </label>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <label for="total" class="form-label"> Add the amounts above for qualifying children and other
                        dependents. You may add to this amount of any other credits.
                        Enter Total here </label>
                    <input type="tel" class="form-control" id="total" name="total" required>
                </div>
            </div>
            <div id="btnWrap" class="d-flex justify-content-between">
            ...
            <div id="step3" style="display: none;">
                <h3>(Optional) Other Adjustments</h3>
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="otherincome" class="form-label">Ohter income (not from jobs)</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="tel" class="form-control" id="extra_withholding" name="extra_withholding" required>
                    </div>
                </div>
                <div id="btnWrap" class="d-flex justify-content-between">
            ...
            <div id="step4" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="sign" class="form-label">Employee's Signature </label>
                        <input type="text" class="form-control" id="sign" name="sign" required>
                    </div>
                    <div class="col-md-4">
                        <label for="sign" class="form-label">Date </label>
        ...
        <div id="step5" style="display: none;">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="employersname" class="form-label">Employers Name</label>
                        <input type="text" class="form-control" id="employersname" name="employers_name" required>
                    </div>
                    <div class="col-md-4">
                        <label for="firstdateofemployement" class="form-label">First Date of employement </label>
                        <input type="date" class="form-control" id="firstdateofemployement" name="first_date_of_employement" required>
                    </div>
                    <div class="col-md-4">
                        <label for="ein" class="form-label">Employee Identification Number (EIN) </label>
                        <input type="number" class="form-control" id="ein" name="ein" required>
                    </div>
                </div>
                <div id="btnWrap" class="d-flex justify-content-between">
    ...
    function downloadPDF() {
        ...
        // Last Name section
        yPosition = addSection('Last Name:', document.getElementById('lastname').value, yPosition);
        ...
        yPosition = addSection('Current Status:', document.getElementById('martial_status').value, yPosition);

        // Social Security Number section
        yPosition = addSection('Social Security Number:', document.getElementById('ssn').value, yPosition);

        // Under 17 Children section
        yPosition = addSection('Qualifying Children under 17:', document.getElementById('under17').value, yPosition);

        // Other dependents section
        yPosition = addSection('Other Dependents:', document.getElementById('other').value, yPosition);

        // Total Section
        yPosition = addSection('Total:', document.getElementById('total').value, yPosition);

        // Other Income section
        yPosition = addSection('Other Income (not from jobs):', document.getElementById('otherincome').value, yPosition);

        // Deductions section
        yPosition = addSection('Deductions:', document.getElementById('deductions').value, yPosition);

        // Extra Withholding section
        yPosition = addSection('Extra Withholding:', document.getElementById('extra_withholding').value, yPosition);

        // Employee Signature section
        yPosition = addSection('Employee Signature:', document.getElementById('sign').value, yPosition);

        // Date section
        yPosition = addSection('Date:', document.getElementById('date').value, yPosition);

        // Employer Section
        yPosition = addSection('Employer Name:', document.getElementById('employersname').value, yPosition);
        yPosition = addSection('First Date of Employment:', document.getElementById('firstdateofemployement').value, yPosition);
        yPosition = addSection('Employee Identification Number (EIN):', document.getElementById('ein').value, yPosition);
        ...
        // File Notes section
        yPosition = addSection('File Notes:', 'N/A', yPosition);

        // Save or print the PDF
        doc.save('W4_Form.pdf');
    }
    document.addEventListener('DOMContentLoaded', function() {

    // Attach the function to the button to download the PDF when clicked
...
<script>
    ...
    function updateHeading(step) {
        ...
        switch (step) {
            case 1:
                heading.textContent = "W4 Form - 1/5";
                break;
            case 2:
                heading.textContent = "W4 Form - 2/5";
                break;
            case 3:
                heading.textContent = "W4 Form - 3/5";
                break;
            case 4:
                heading.textContent = "W4 Form - 4/5";
                break;
            case 5:
                heading.textContent = "W4 Form - 5/5";
                break;
            default:
                heading.textContent = "W4 Form";
        }
    }
