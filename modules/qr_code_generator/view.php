    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="d-flex align-items-center justify-content-end mt-2 mb-3">
                <div style="margin-top: 10px !important;">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="?route=modules/qr_code_generator/qr_code_generator"><?php echo lang("user_users"); ?></a>
                        </li>
            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                <div>
                    <a href="?route=modules/qr_code_generator/qr_code_generator" class="btn btn-outline-primary">
