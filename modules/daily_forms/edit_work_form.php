            ...
            <div class="form-step" data-step="3">
                <div class="form-section">
                    ...
                    <!-- <div id="equipmentContainer">
                        <div class="row dynamic-row g-2 align-items-end">
                            <div class="col-md-6">
                                <label class="form-label"><?php echo lang("Equipment Id"); ?></label>
                                <input type="text" name="equipment[][tool_id]" class="form-control" value="<?= htmlspecialchars($equipment['tool_id'] ?? '') ?>">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label"><?php echo lang("workform_Quantity"); ?></label>
                                <input type="number" name="equipment[][quantity]" class="form-control" min="1" value="<?= htmlspecialchars($equipment['quantity'] ?? '') ?>">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label"><?php echo lang("workform_Hours_Used"); ?></label>
                                <input type="number" name="equipment[][hours_used]" class="form-control" min="0" step="0.5" value="<?= htmlspecialchars($equipment['hours_used'] ?? '') ?>">
                            </div>
                            <div class="col-md-1">
                                <button type="button" class="btn btn-outline-danger w-100"><i class="bi bi-trash"></i></button>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() 
        {
            ...
            form?.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const response = await fetch('ajax_helpers/edit_daily_forms.php', {
                        method: 'POST',
                        body: formData
                    });
