...
$crews = DB::query("SELECT * FROM crew");
 ...
 if (isset($_GET['id'])) {
    ...
    $subcontractors = DB::queryFirstRow("SELECT * FROM subcontractors WHERE id = %i", $Id);
    // $equipment = DB::queryFirstRow("SELECT * FROM equipment_usage WHERE report_id = %i", $Id);
...
<body>
                    ...
                    <div class="row g-3">
                       ...
                       <div class="col-md-6">
                        ...
                        <select class="form-select" id="jobSelect" name="job_id">
                            <option value="" disabled <?= empty($daily_report['job_id']) ? 'selected' : '' ?>>
                                <?php echo lang("workform_select_a_Job"); ?>
                            </option>
                            <?php foreach ($jobs as $job): ?>
                                <option value="<?= $job['id']; ?>" 
                                    <?= (isset($daily_report['job_id']) && $daily_report['job_id'] == $job['id']) ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" id="reportDate" name="report_date" value="<?= htmlspecialchars($daily_report['report_date'] ?? '') ?>" readonly>
                        </div>
                       ...
                       <div class="col-md-3">
                        ...
                        <select class="form-select" id="shiftSelect" name="shift">
                            <option value="1" 
                                <?= (isset($daily_report['craft_count']) && $daily_report['shift'] == 1) ? 'selected' : '' ?>>
                                <?php echo lang("workform_Day"); ?>
                            </option>
                            <option value="2" 
                                <?= (isset($daily_report['craft_count']) && $daily_report['shift'] == 2) ? 'selected' : '' ?>>
                                <?php echo lang("workform_Night"); ?>
                            </option>
                        </select>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control w-25" id="foremanInput" value="<?php echo htmlspecialchars($username); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="border rounded p-3 bg-light">
                                <div class="row">
                                    ...
                                    // New
                                    // Get site conditions from database
                                    $dbSiteConditions = isset($daily_report['site_conditions']) ? explode(',', $daily_report['site_conditions']) : [];
                                    
                                    foreach ($siteConditionOptions as $value => $label) {
                                        $checked = in_array($value, $dbSiteConditions) ? 'checked' : '';
                                        echo '<div class="col-6 mb-2">';
                                        echo '<div class="form-check">';
                                        echo '<input class="form-check-input" type="checkbox" name="site_conditions[]" id="site_condition_' . str_replace(' ', '_', $value) . '" value="' . $value . '" ' . $checked . '>';
                ...
                <div class="form-section">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="craft_count" id="craftCount" min="0" max="999" oninput="this.value=this.value.slice(0,3)" style="width: 80px;"  value="<?= htmlspecialchars($daily_report['craft_count'] ?? '') ?>">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div id="subcontractorsContainer">
                                <?php
                                // Fetch all subcontractors for this report
                                ...
                                if (!empty($subcontractors)) {
                                    foreach ($subcontractors as $index => $subcontractor) {
                                        ?>
                                        <div class="row dynamic-row g-2 align-items-end mb-2">
                                            <div class="col-md-6 w-25">
                                                <input type="text" class="form-control" 
                                                    name="subcontractors[][name]" 
                                                    value="<?= htmlspecialchars($subcontractor['subcontractor_name'] ?? '') ?>">
                                            </div>
                                            <div class="col-md-4 " style="width: 160px;">
                                                <input type="number" class="form-control" 
                                                    name="subcontractors[][headcount]" 
                                                    value="<?= htmlspecialchars($subcontractor['headcount'] ?? '') ?>" 
                                                    min="0">
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    // Show empty row if no subcontractors exist
                                    ?>
                                    <div class="row dynamic-row g-2 align-items-end">
                                        <div class="col-md-6 w-25">
                                            <input type="text" class="form-control" name="subcontractors[][name]" value="">
                                        </div>
                                        <div class="col-md-4" style="width: 160px;">
                                            <input type="number" class="form-control" name="subcontractors[][headcount]" value="" min="0">
                                        </div>
                                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="total_head_count" class="form-control" id="totalHeadCount" style="width: 80px;" value="<?= htmlspecialchars($daily_report['total_head_count'] ?? '') ?>" readonly>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-step" data-step="3">
                <div class="form-section">
                    ...
                    <div id="equipmentContainer">
                        <?php
                        // Fetch all equipment for this report
                        ...
                        if (!empty($equipment)) {
                            foreach ($equipment as $index => $equipmentItem) {
                                ...
                                <div class="row dynamic-row g-2 align-items-end mb-2">
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="equipment[][tool_id]" class="form-control" 
                                            value="<?= htmlspecialchars($equipmentItem['tool_id'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-1">
                                        <label class="form-label"><?php echo lang("workform_Quantity"); ?></label>
                                        <input type="number" name="equipment[][quantity]" class="form-control" min="1" 
                                            value="<?= htmlspecialchars($equipmentItem['quantity'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-1">
                                        ...
                                        <input type="number" name="equipment[][hours_used]" class="form-control" min="0" step="0.5" 
                                            value="<?= htmlspecialchars($equipmentItem['hours_used'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-1">
                                        <button type="button" class="btn btn-outline-danger w-100">
                                            <i class="bi bi-trash"></i>
                            ...
                            // Show empty row if no equipment exists
                            ?>
                            <div class="row dynamic-row g-2 align-items-end">
                                <div class="col-md-2">
                                    <label class="form-label"><?php echo lang("workform_Equipment_Name"); ?></label>
                                    <input type="text" name="equipment[][tool_id]" class="form-control" value="">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label"><?php echo lang("workform_Quantity"); ?></label>
                                    <input type="number" name="equipment[][quantity]" class="form-control" min="1" value="">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label"><?php echo lang("workform_Hours_Used"); ?></label>
                                    <input type="number" name="equipment[][hours_used]" class="form-control" min="0" step="0.5" value="">
                                </div>
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-outline-danger w-100"><i class="bi bi-trash"></i></button>
                                </div>
            ...
            <div class="form-step" data-step="4">
                <div class="form-section">
                    ...
                    <div id="materialsContainer">
                        <?php
                        // Fetch all materials for this report
                        ...
                        if (!empty($material)) {
                            foreach ($material as $index => $materialItem) {
                                ...
                                <div class="row dynamic-row g-2 align-items-end mb-2">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="materials[][name]" class="form-control" 
                                            value="<?= htmlspecialchars($materialItem['material_name'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-1">
                                        <label class="form-label"><?php echo lang("workform_Quantity"); ?></label>
                                        <input type="number" name="materials[][quantity]" class="form-control" min="1" 
                                            value="<?= htmlspecialchars($materialItem['quantity'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label"><?php echo lang("workform_Comments"); ?></label>
                                        <input type="text" name="materials[][comments]" class="form-control" 
                                            value="<?= htmlspecialchars($materialItem['comments'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-1">
                                        <button type="button" class="btn btn-outline-danger w-100">
                                            <i class="bi bi-trash"></i>
                            ...
                            // Show empty row if no materials exist
                            ?>
                            <div class="row dynamic-row g-2 align-items-end">
                                <div class="col-md-3">
                                    <label class="form-label"><?php echo lang("workform_Material_Name"); ?></label>
                                    <input type="text" name="materials[][name]" class="form-control" value="">
                                </div>
                                <div class="col-md-1">
                                    <label class="form-label"><?php echo lang("workform_Quantity"); ?></label>
                                    <input type="number" name="materials[][quantity]" class="form-control" min="1" value="">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label"><?php echo lang("workform_Comments"); ?></label>
                                    <input type="text" name="materials[][comments]" class="form-control" value="">
                                </div>
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-outline-danger w-100"><i class="bi bi-trash"></i></button>
                                </div>
            ...
            <div class="form-step" data-step="5">
                <!-- New -->
                 <div class="form-section">
                    ...
                    <textarea class="form-control notes-area" name="notes" rows="8"><?= 
                    // Properly escape notes content for textarea
                     htmlspecialchars($daily_report['notes'] ?? '') 
                    ?></textarea>
                </div>
                <!-- old -->
                <!-- <div class="form-section">
                    <h2 class="section-title"><i class="bi bi-pencil"></i> <?php echo lang("workform_Notes"); ?></h2>
                    <textarea class="form-control notes-area" name="notes" value="<?= htmlspecialchars($daily_report['notes'] ?? '') ?>"></textarea>
                </div> -->
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <?php if (!empty($signature['signature_data']) && strpos($signature['signature_data'], 'data:image/') === 0): ?>
                                    <img src="<?= htmlspecialchars($signature['signature_data']) ?>" alt="Applicant Signature"
    ...
    <div class="d-flex align-items-center gap-3">
        <!-- Lock Form Toggle -->
        <div class="btn-group lock-toggle-group" role="group" style="background-color: white; border: none; padding: 0; margin: 0; display: inline-block;">
    <input type="hidden" name="lockForm" value="1">
    <input type="checkbox" class="btn-check" id="lockForm" name="lockForm" value="1" autocomplete="off" checked disabled>
    <label class="btn d-flex align-items-center gap-2" for="lockForm" 
           style="background-color: white; color: white; border: none; padding: 0; margin: 0;">
    ...
    <i class="bi bi-check-circle"></i> <?php echo lang("workform_submit_lock_form"); ?>
</button>
    </div>
</div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() 
    {
        ...
        document.getElementById('dailyReportForm').addEventListener('submit', function(e) {
            if (signaturePad.isEmpty()) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: '<?php echo lang("form_provide_signature"); ?>',
        ...
        form?.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch('ajax_helpers/lock_daily_forms.php', {
                    method: 'POST',
                    body: formData
                });
                ...
                window.location.href = 'index.php?route=modules/daily_forms/view_work_form';
            } catch (error) {
